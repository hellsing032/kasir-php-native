...
$h2 = mysqli_num_rows($h1); //ini adalah jumlah pesanan
?>
<!DOCTYPE html>
<html lang="en">
    <head>
                                ...
                                <table id="datatablesSimple">
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?=$jumlah?></td>
                                            <td>
                                                <a href="view.php?idp=<?=$idorder;?>" class="btn btn-success" target="blank">Tampilkan</a>
                    ...
                    <div class="modal-body">
                        ...
                        <select name="idpelanggan" class="form-control">
                            ...
                            while($pl=mysqli_fetch_array($getpelanggan)){
                                ...
                                $alamat = $pl['alamat'];
                            ?>
                            <option value="<?=$pl['idpelanggan'];?>"><?=$namapelanggan;?> - <?=$alamat;?></option>
                            <?php
                            }; //end of while
                            ?>
                        </select>
