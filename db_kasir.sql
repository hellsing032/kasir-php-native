...
(1, 'Hikam', '085773228880', 'Bogor'),
(2, 'Nasser', '628577442211', 'Cibinong'),
(3, 'Ahmad Aprilli', '089613145912', 'Bojong Gede'),
(5, 'Yuswan Yanto', '089617897456', 'Citereup');
...
(2023000004, '2023-07-21 20:49:54', 5);
...
(1, 'Kertas Ajaib', 'A4', 2000, 101),
(2, 'Gelas', 'Ikea Glass', 50000, 205),
(3, 'Pulpen', 'Pilot', 2000, 9);
...
--
ALTER TABLE `detailpesanan`
  MODIFY `iddetailpesanan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `pesanan`
  MODIFY `idorder` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2023000005;
